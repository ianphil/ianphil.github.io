...
- Identify recurring "problem classes" (provisioning, config changes, incident response, routine updates) and capture them as templates with clear inputs/outputs.    
...
- Build verification into the default flow: automated checks, policy checks, and structured acceptance criteria before anything lands.
